...
class LessonCRUDTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course2 = Course.objects.create(
            ...
            description='Курс по Django фреймворку',
            owner=self.teacher
        )
    ...
    def test_create_lesson_without_url(self):
        ...
        data = {
            'name': 'Урок без видео',
            'description': 'Урок без ссылки на видео',
            'course': self.course1.id
        }
    ...
    def test_retrieve_lesson(self):
        ...
        response = self.client.get(
            reverse('study:lesson-retrieve', args=[self.lesson1.id])
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_lesson_by_owner(self):
        ...
        response = self.client.delete(
            reverse('study:lesson-delete', args=[self.lesson1.id])
        )
